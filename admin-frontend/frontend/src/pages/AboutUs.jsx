...
const defaultData = {
  ...
  why_choose_points: [
    { title: 'বিশ্বস্ততা', description: 'আমরা রংপুর বিভাগের সবচেয়ে বিশ্বস্ত স্বাস্থ্যসেবা প্ল্যাটফর্ম - ইজি ডক্টর রংপুর' },
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="relative bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-950 text-white overflow-hidden pt-28 pb-40">
        <div className="absolute inset-0">
          ...
          <div className="absolute -top-32 -left-32 w-96 h-96 bg-gradient-to-br from-teal-400/30 to-emerald-500/20 rounded-full blur-[100px]"></div>
          <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-gradient-to-tl from-cyan-400/25 to-teal-500/15 rounded-full blur-[80px]"></div>
          <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-gradient-to-bl from-emerald-300/20 to-teal-400/10 rounded-full blur-[70px] animate-pulse"></div>
        </div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="text-center lg:text-left lg:max-w-2xl">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-teal-400/20 to-cyan-400/20 backdrop-blur-md px-6 py-3 rounded-2xl mb-8 border border-teal-400/30 shadow-lg shadow-teal-500/10">
                <div className="w-8 h-8 bg-gradient-to-br from-teal-400 to-emerald-500 rounded-lg flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
                <span className="text-sm font-semibold text-teal-300">আমাদের সম্পর্কে জানুন</span>
              </div>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
                <span className="bg-gradient-to-r from-white via-teal-100 to-emerald-200 bg-clip-text text-transparent">{data.hero_title}</span>
              </h1>
              <p className="text-2xl md:text-3xl text-teal-100 mb-4 font-medium">{data.hero_subtitle}</p>
              <p className="text-lg md:text-xl text-teal-200/80 max-w-xl leading-relaxed">{data.hero_description}</p>
            </div>
            <div className="hidden lg:block">
              <div className="relative">
                <div className="w-64 h-64 bg-gradient-to-br from-teal-400/20 to-emerald-500/20 backdrop-blur-xl rounded-3xl border border-white/10 p-6 shadow-2xl -rotate-6 hover:rotate-0 transition-transform duration-500">
                  <div className="w-full h-full bg-gradient-to-br from-teal-500/30 to-emerald-600/30 rounded-2xl flex flex-col items-center justify-center gap-4">
                    ...
                    <div className="text-center">
                      <p className="text-white font-bold">স্বাস্থ্যসেবায়</p>
                      <p className="text-white/70 text-sm">বিশ্বস্ত অংশীদার</p>
                    </div>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-cyan-400 to-teal-500 rounded-2xl flex items-center justify-center shadow-xl shadow-teal-500/40 rotate-12">
                  <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-emerald-400 to-green-500 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/40">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-20">
            <path d="M0 120L48 108C96 96 192 72 288 60C384 48 480 48 576 54C672 60 768 72 864 78C960 84 1056 84 1152 78C1248 72 1344 60 1392 54L1440 48V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0Z" fill="#f9fafb"/>
          </svg>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">{data.who_we_are_title}</h2>
            <p className="text-gray-600 text-lg leading-relaxed">{data.who_we_are_content}</p>
          </div>
          <div className="relative">
            <div className="bg-gradient-to-br from-teal-500 to-emerald-600 rounded-3xl p-8 text-white shadow-xl">
              ...
              <p className="text-teal-100 leading-relaxed">{data.vision_content}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{data.mission_title}</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">{data.mission_content}</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {data.mission_points.map((point, index) => (
              <div key={index} className="flex items-center gap-3 bg-teal-50 rounded-xl p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {data.stats.map((stat, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-4 text-white">
                {statIcons[stat.icon] || statIcons.doctors}
              </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{data.services_title}</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {data.services.map((service, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all hover:-translate-y-1">
                <div className="w-14 h-14 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-2xl flex items-center justify-center mb-4 text-white">
        ...
        <div className="bg-gradient-to-r from-teal-600 to-emerald-600 rounded-3xl p-8 md:p-12 mb-20 text-white">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">{data.why_choose_title}</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{data.team_title}</h2>
            <p className="text-gray-600">{data.team_description}</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {data.team_members.map((member, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-teal-600 font-medium text-sm mb-2">{member.position}</p>
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          <div className="grid lg:grid-cols-2">
            <div className="p-8 md:p-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">{data.contact_title}</h2>
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{data.contact_address}</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-teal-600 to-emerald-700 p-8 md:p-12 text-white flex flex-col justify-center">
              <h3 className="text-2xl font-bold mb-4">আমাদের সাথে যুক্ত থাকুন</h3>
              <p className="text-teal-100 mb-6">{data.footer_message}</p>
              <div className="flex gap-4">
                {data.social_facebook && (
                  <a href={data.social_facebook} target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/20 hover:bg-white/30 rounded-xl flex items-center justify-center transition-colors">
              ...
              <div className="mt-8">
                <Link to="/contact" className="inline-flex items-center gap-2 bg-white text-teal-700 px-6 py-3 rounded-xl font-semibold hover:bg-teal-50 transition-colors">
                  বিস্তারিত যোগাযোগ
