      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center">
            <img src="/logo-navbar.png" alt="ইজি ডক্টর রংপুর" className="h-10 object-contain" width="150" height="40" />
          </Link>
          ...
          <div className="md:hidden">
            <button 
              ...
              className="text-gray-700 p-2 focus:outline-none focus:ring-2 focus:ring-primary-500 rounded-lg"
