        ...
        <div className="py-10 lg:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            <div className="sm:col-span-2 lg:col-span-4">
              <img src="/logo-footer.png" alt="Easy Doctor Rangpur" className="h-20 object-contain object-left mb-4 block" width="220" height="80" loading="lazy" />
              <p className="text-slate-400 text-sm leading-relaxed mb-6 max-w-sm text-left">
