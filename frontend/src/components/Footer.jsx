          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            <div className="sm:col-span-2 lg:col-span-4">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <Link to="/doctor.admin/login" className="w-10 h-10 bg-slate-800 hover:bg-teal-500 rounded-lg flex items-center justify-center transition-all duration-300 group" title="ডাক্তার প্যানেল">
