...
const categories = [
  ...
  { id: 'ent', name: 'নাক-কান-গলা বিশেষজ্ঞ', nameEn: 'ইএনটি', icon: '/icons/ent.webp' },
  { id: 'dermatology', name: 'চর্মরোগ বিশেষজ্ঞ', nameEn: 'ডার্মাটোলজি', icon: '/icons/dermatology.webp' },
  { id: 'psychiatry', name: 'মানসিক রোগ বিশেষজ্ঞ', nameEn: 'সাইকিয়াট্রি', icon: '/icons/psychiatry.webp' },
                  ...
                  <div className="absolute top-3 right-3">
                    {doctor.is_verified && (
                      <div className="flex items-center gap-1">
                        <span className="text-[11px] font-bold text-white leading-none tracking-wide drop-shadow">verified</span>
                        <img
